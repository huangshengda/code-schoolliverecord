...
public class Validation {
	 ...
	 * 验证用户名
	 */
	private static final String P_USERNAME = "^[0-9a-zA-Z|,|.|;|~|!|@|@|#|$|%|\\^|&|*|(|)|_|+|\\-|=|\\\\|/|<|>]{5,30}$";
	/**
	 * 验证 e-mail 的正则式
	 */
	 ...
	 * 验证 IP 地址
	 */
	private static final String P_IP = "^([1-9]|[1-9]\\d|1\\d{2}|2[0-4]\\d|25[0-5])(\\.(\\d|[1-9]\\d|1\\d{2}|2[0-4]\\d|25[0-5])){3}$";
	/**
	 * 中文英文数字
	 */
	private static final String P_ZH_EN_NUMBER = "^[\u4e00-\u9fa5（）()a-zA-Z0-9]{2,18}$";
	 ...
	 * 验证Ip地址
	 */
	public static final int ZH_EN_NUMBER = 8;
