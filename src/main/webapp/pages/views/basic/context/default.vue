    ...
    <form action="" id="condition">
      <div class="cd-f-row">
        ...
        <div class="cd-f-eve">
          ...
          <span class="cd-f-value ">
            <select name="userType"><option value="ADMIN">管理员</option>
  ...
  <input type="hidden" name="userId" id="userId">
   <div class="cd-f-row">
        <div class="cd-f-eve">
          ...
          <span class="cd-f-value" name="username" id="username">
        ...
        <div class="cd-f-eve">
          ...
          <span class="cd-f-value">
            <input type="text" name="password" id="password" data-vali="notnull,password">
          </span>
        </div>
        <div class="cd-f-eve">
...
<script>
  export default {
   ...
   var user_edit = function(params,dom){
                  layer.open({
                        type: 1,
                        title: '编辑用户',
                        skin: 'layui-layer-rim', //加上边框
                      ...
                      CDUtil.ajaxPost("/base/user/update", editparams, function(retVO){
                             if(retVO.code == 1){
                            	 $('#userId').val(retVO.data.userId);
                                $('#userType').val(retVO.data.userType);
                                $('#usernasme').val(retVO.data.username);
                                $('#realname').val(retVO.data.realname);
                                md5($('#password').val(retVO.data.password));
                              }
                            });
              			}
                    });
                }
   var user_del = function(params,dom){
