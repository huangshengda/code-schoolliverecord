...
<script type="text/javascript" src="<%=ROOT_UI_DIST%>/slr_demond.js" ></script>
<script  type="text/javascript" src="<%=ROOT_UI_PUBLIC%>/_module/demond/demond_detail.js"></script>
<style type="text/css">
</style>
</head>
<body>
